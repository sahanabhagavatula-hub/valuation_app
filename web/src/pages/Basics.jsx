...
function DcfDiagram() {
  return (
    <svg viewBox="0 0 800 180" style={{ width: '100%', maxWidth: 800, display: 'block', margin: '0 auto' }}>
      <text x="0" y="20" fill="#8e8675" fontSize="11" fontFamily="Urbanist, sans-serif">Year 1</text>
      <text x="120" y="20" fill="#8e8675" fontSize="11" fontFamily="Urbanist, sans-serif">Year 2</text>
      <text x="240" y="20" fill="#8e8675" fontSize="11" fontFamily="Urbanist, sans-serif">Year 3</text>
      <text x="360" y="20" fill="#8e8675" fontSize="11" fontFamily="Urbanist, sans-serif">Year 4</text>
      <text x="480" y="20" fill="#8e8675" fontSize="11" fontFamily="Urbanist, sans-serif">Year 5</text>
      <text x="610" y="20" fill="#c9a875" fontSize="11" fontFamily="Urbanist, sans-serif">Terminal value</text>
      ...
      <text x="45" y="59" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">FCF</text>
      <text x="165" y="59" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">FCF</text>
      <text x="285" y="59" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">FCF</text>
      <text x="405" y="59" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">FCF</text>
      <text x="525" y="59" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">FCF</text>
      <text x="695" y="59" fill="#9ed8f0" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif">"Forever" growth</text>

      <line x1="45" y1="85" x2="400" y2="130" stroke="#6b9b94" strokeWidth="1.5" strokeDasharray="3,3" />
      <line x1="165" y1="85" x2="400" y2="130" stroke="#6b9b94" strokeWidth="1.5" strokeDasharray="3,3" />
      <line x1="285" y1="85" x2="400" y2="130" stroke="#6b9b94" strokeWidth="1.5" strokeDasharray="3,3" />
      <line x1="405" y1="85" x2="400" y2="130" stroke="#6b9b94" strokeWidth="1.5" strokeDasharray="3,3" />
      <line x1="525" y1="85" x2="400" y2="130" stroke="#6b9b94" strokeWidth="1.5" strokeDasharray="3,3" />
      <line x1="695" y1="85" x2="400" y2="130" stroke="#9ed8f0" strokeWidth="1.5" strokeDasharray="3,3" />

      <circle cx="400" cy="130" r="6" fill="#3d6b66" />
      <text x="400" y="155" fill="#ffffff" fontSize="13" textAnchor="middle" fontFamily="Urbanist, sans-serif" fontWeight="600">
        Company value today
      </text>
      <text x="400" y="172" fill="#8e8675" fontSize="10.5" textAnchor="middle" fontFamily="Urbanist, sans-serif">
