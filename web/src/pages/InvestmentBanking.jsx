...
const TOPICS = [
  ...
  { tag: 'good to have', title: 'Precedent transactions', description: 'Valuing a company based on what similar companies sold for in past M&A deals. Fully built — try it now.', path: '/precedent-transactions', icon: 'clock', lessons: 6, minutes: 36 },
];
